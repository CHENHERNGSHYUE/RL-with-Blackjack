...
from Blackjack_AI_strategy_2_r import Blackjack
from Sarsa_learning_r import Sarsa_table
import csv
import time
...
if __name__ == "__main__":
    ...
    rl.s_table.to_csv(r'export_Sarsatable.csv', header=True) # export Sarsa Table
