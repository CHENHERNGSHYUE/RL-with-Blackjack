...
from Blackjack_dealer_strategy_r2 import Blackjack
...
#--------------------------------------------------------------------    
    with open('strategy.csv', 'w', newline='') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(['Current cards in the deck', 'Action', 'Win or not', 'Current asset', 'Asset after betting', 'Terminal or not'])
